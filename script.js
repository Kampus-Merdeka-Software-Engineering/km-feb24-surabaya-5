...
const updateChart = (chart, data, category, year) => {
  ...
  if (category.toLowerCase() === 'bikes') {
    ...
    filteredData = filteredData.sort((a, b) => a.value - b.value); // Sort in descending order for others
  }
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const table = $('#example').DataTable({
    responsive: true,
    columns: [{ data: 'Product' }, { data: 'Product_Category' }, { data: 'Year' }, { data: 'Order_Quantity' }],
  });
